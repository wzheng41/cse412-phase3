...
class DraftAdmin(admin.ModelAdmin):
    list_display = ('permit_id','yelp_id') # 展示的哪些字段
...
class InspectionsAdmin(admin.ModelAdmin):
    list_display = ('inspection','permit_id','date','time','inspection_type','critical_violations',
                    ...
                    'non_critical_violations_corrected_on_site','non_critical_violations_to_be_resolved') # 展示的哪些字段？
...
class OpentableAdmin(admin.ModelAdmin):
    list_display = ('permit_id','opentableid') # 展示的哪些字段？
    list_display_links = ('permit_id',) #
...
class RestaurantsAdmin(admin.ModelAdmin):
    list_display = ('permit_id','name','address','lattitude','longitude',) # 展示的哪些字段？
    list_display_links = ('permit_id',) #
...
class ViolationcodeskeyAdmin(admin.ModelAdmin):
    list_display = ('violation_number','violation_description','violation_category',) # 展示的哪些字段？
...
class ViolationsAdmin(admin.ModelAdmin):
    list_display = ('inspection_id','violation_number','violation_text',) # 展示的哪些字段？
